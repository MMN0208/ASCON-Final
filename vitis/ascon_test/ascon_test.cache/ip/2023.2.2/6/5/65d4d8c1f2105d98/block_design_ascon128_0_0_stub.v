...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(s_axi_ASCON128_AWADDR, 
  ...
  in_stream_TDATA, in_stream_TLAST, in_stream_TKEEP, in_stream_TSTRB, in_stream_TUSER, 
  out_stream_TVALID, out_stream_TREADY, out_stream_TDATA, out_stream_TLAST, 
  out_stream_TKEEP, out_stream_TSTRB, out_stream_TUSER)
/* synthesis syn_black_box black_box_pad_pin="s_axi_ASCON128_AWADDR[7:0],s_axi_ASCON128_AWVALID,s_axi_ASCON128_AWREADY,s_axi_ASCON128_WDATA[31:0],s_axi_ASCON128_WSTRB[3:0],s_axi_ASCON128_WVALID,s_axi_ASCON128_WREADY,s_axi_ASCON128_BRESP[1:0],s_axi_ASCON128_BVALID,s_axi_ASCON128_BREADY,s_axi_ASCON128_ARADDR[7:0],s_axi_ASCON128_ARVALID,s_axi_ASCON128_ARREADY,s_axi_ASCON128_RDATA[31:0],s_axi_ASCON128_RRESP[1:0],s_axi_ASCON128_RVALID,s_axi_ASCON128_RREADY,ap_rst_n,interrupt,in_stream_TVALID,in_stream_TREADY,in_stream_TDATA[63:0],in_stream_TLAST[0:0],in_stream_TKEEP[7:0],in_stream_TSTRB[7:0],in_stream_TUSER[0:0],out_stream_TVALID,out_stream_TREADY,out_stream_TDATA[63:0],out_stream_TLAST[0:0],out_stream_TKEEP[7:0],out_stream_TSTRB[7:0],out_stream_TUSER[0:0]" */
