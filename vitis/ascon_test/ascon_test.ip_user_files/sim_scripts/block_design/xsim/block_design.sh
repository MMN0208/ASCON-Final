...
simulate()
{
  xsim block_design -key {Behavioral:sim_1:Functional:block_design} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_71e8.protoinst" -protoinst "protoinst_files/block_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb block_design.wdb xsim.dir libdpi.so)
